		...
		<div class="row">
				...
				<div class="col-xs-12 col-sm-8 col-md-9 col-lg-9">
					<h4>
						...
						@endif
							<img src="{{asset('storage')}}/{{str_replace('public','',$history->photo)}}" class="rounded-circle" alt="image" style="border: 1px solid;height: 30px;width: 30px;margin-right: 20px;margin-left: 20px;">
							 {{$history->firstname}}
						</a>
					</h4>
				</div>
